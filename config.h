...
#define FFTW_CC "arm-linux-androideabi-gcc --sysroot=/opt/android-sdk/ndk-bundle/platforms/android-21/arch-arm/ -march=armv7-a -mfloat-abi=softfp -mfpu=neon -fno-builtin-memmove -mthumb -D__ANDROID_API__=21"
